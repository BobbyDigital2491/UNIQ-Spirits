...
const Info = () => {
  ...
  <div className="relative p-4 sm:p-6 lg:p-8">
    <p className="text-sm text-right font-medium uppercase tracking-widest text-yellow-400">
      Category
    </p>

    <p className="text-xl text-right font-bold text-white sm:text-2xl">News</p>
  ...
  <div className="relative p-4 sm:p-6 lg:p-8">
    ...
    <p className="text-xl font-bold text-white text-right sm:text-2xl">Podcasts</p>
