  ...
  <div className="flex items-start sm:gap-8">
    ...
    <div>
      ...
      <h3 className="mt-4 text-lg font-medium sm:text-xl">
        <a href="/ep1" className="text-white hover:underline"> Outliers & Teachers </a>
      </h3>
      ...
      <div className="mt-4 sm:flex sm:items-center sm:gap-2">
        ...
        <h1 className="mt-2 text-xs font-medium text-gray-400 sm:mt-0">
          Featuring <a href="#" className=" hover:text-white">F Classic</a>,
           and
          <h1 className=" hover:text-white">Dizzy Spades</h1>
        </h1>
      </div>
    </div>
  </div>
